...
public class Prayer {
	...
	public static int getPointPercentage() {
		return (int) (((getRemainingPoints() / ((float) Skills.getRealLevel(Skills.PRAYER) * 10))) * 100);
	}
	...
	public static boolean setActivated(final Effect effect, final boolean activate) {
		if (activate != isActive(effect) && (!activate || effect.getRequiredLevel() <= Skills.getRealLevel(Skills.PRAYER) && getRemainingPoints() > 0)) {
